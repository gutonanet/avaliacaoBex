...
Para executar a Interface do Shell, execute a classe "com.lemes.augusto.bex.execute.BestRouteExecute" que possui um metodo main. 
Para executar a Interface Rest, execute a classe "com.lemes.augusto.bex.BexApplication" ou "java -jar bex-0.0.1-SNAPSHOT.jar" ou na pasta do projeto execute "mvn spring-boot:run".
